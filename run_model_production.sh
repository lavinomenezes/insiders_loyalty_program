...
$path_to_bibli/papermill $path/src/models/insider_clustering_v10_deploy_light_production.ipynb $path/reports/insider_clustering_v09_deploy_light_$data.ipynb
